...
public interface ProjectService {
	 ...
	 * @return
	 */
	Project create(Project project) throws JsonParseException, JsonMappingException, IOException;
	 ...
	 * @throws JsonParseException 
	 */
	Project update(Integer id, Project project) throws JsonParseException, JsonMappingException, IOException;
	 ...
	 * @throws JsonParseException 
	 */
	Project updateWithLock(Integer id, Project project) throws JsonParseException, JsonMappingException, IOException;
	 ...
	 * @throws JsonParseException 
	 */
	Project updateForDelete(Integer id, Integer version) throws JsonParseException, JsonMappingException, IOException;
	 ...
	 * @throws JsonParseException 
	 */
	Project updateForDeleteWithLock(Integer id, Integer version) throws JsonParseException, JsonMappingException, IOException;
